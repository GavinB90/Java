...
public class Main {
    ...
    private static MobilePhone mobilePhone = new MobilePhone("1234436345634");
    ...
    private static void removeContact(){
        ...
        String newName = scanner.nextLine();
        Contact existingRecord = mobilePhone.queryContact(newName);
        if(existingRecord == null){
            System.out.println("Contact not found.");
            return;
        }
    ...
    private static void queryContact(){
        ...
        if(existingRecord == null){
            ...
            System.out.println("Contact name " + mobilePhone.queryContact(existingRecord) + " was found.");
